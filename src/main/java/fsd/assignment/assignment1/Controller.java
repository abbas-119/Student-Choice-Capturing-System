...
public class Controller {
    ...
    public void initialize() {
        ...
        studentListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Student>() {
            ...
            public void changed(ObservableValue<? extends Student> observable, Student oldValue, Student newValue) {
                ...
                */
                if (newValue!=null){
                    Student item=(Student) Controller.this.studentListView.getSelectionModel().getSelectedItem();
                    Controller.this.yearStudyView.setText(item.getYearOfStudy());
                    Controller.this.mod1View.setText(item.getModule1());
                    Controller.this.mod2View.setText(item.getModule2());
                    Controller.this.mod3View.setText(item.getModule3());
                }
            }
        });
        ...
        */
        ...
        this.mod1Choice.getItems().addAll(modChoices);
        this.mod2Choice.getItems().addAll(modChoices);
        this.mod3Choice.getItems().addAll(modChoices);
        ...
        */
        ...
        deleteStudent.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                 ...
                 */
                Student item=(Student) Controller.this.studentListView.getSelectionModel().getSelectedItem();
                Controller.this.deleteStudent(item);
            }
        });
        ...
        editStudent.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                */
                Student item=(Student) Controller.this.studentListView.getSelectionModel().getSelectedItem();
                Controller.this.editStudent(item);
            }
        });
        ...
        */
         ...
         */
        this.studentListView.setItems(sortedByYear);
        this.studentListView.getSelectionModel().setSelectionMode(SelectionMode.SINGLE);
        this.studentListView.getSelectionModel().selectFirst();
    ...
    public void getChoice(ActionEvent event) {
         ...
         */
        if (event.getTarget().equals(mod1Choice)){
            choice1=this.mod1Choice.getValue();
        }
        if (event.getTarget().equals(mod2Choice)){
            choice2 =this.mod2Choice.getValue();
        }
        if (event.getTarget().equals(mod3Choice)) {
            choice3 =this.mod3Choice.getValue();
        }
    }
    ...
    public void editStudent(Student stu) {
        ...
        try {
            ...
            /* TODO: print an appropriate message if it cannot be loaded
                     print stacktrace
             */
            System.out.printf("Could not load the dialog"+"\n");
